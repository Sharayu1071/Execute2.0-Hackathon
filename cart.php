                    ...
                    if(isset($_COOKIE['user_cart'])){
                        ...
                        <?php    } ?>
                                ...
                                <form action="instamojo.php" class="checkout-form pull-right" method="POST">
                                    ...
                                    <input type="submit" class="btn btn-md btn-success" value="Pay Online">
                                </form>
                                
                                <form action="orderplaced.php" class="checkout-form pull-right" method="POST">
                                    <?php
                                        $product_id = '';
                                        foreach($result as $row){
                                            $product_id .= $row['product_id'].',';
                                    ...
                                    <input type="submit" class="btn btn-md btn-success" value="Cash On Delivery">
                                </form>
